...
export const OperationalNotesPanel = memo(function OperationalNotesPanel() {
  ...
  const handleSubmit = () => {
    ...
    addOperationalNote({
      ...
      author: { id: 'u1', name: 'Arjun Mehta', email: 'arjun@dwas.io', role: 'admin', status: 'online', lastActive: new Date().toISOString() },
  ...
  return (
    <div className="p-4">
      <h2 className="text-[14px] font-semibold text-text-primary mb-3">Operational Notes</h2>
